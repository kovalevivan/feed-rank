 ...
 * Использование: node server/run-vk-experiment.js [команда]
 */
...
// Запускаем CLI
const VKExperimentCLI = require('./services/vk-experiment/cli');

async function main() {
  console.log('🔬 VK Views Experiment Launcher');
