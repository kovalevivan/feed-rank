...
const VKExperiment = require('./index-no-dotenv');
const path = require('path');

/**
 * CLI интерфейс для управления экспериментом VK Views (версия без dotenv)
 */
...
class VKExperimentCLI {
  ...
  showHelp() {
    console.log(`
🔬 VK Views Experiment CLI (No DotEnv Version)
